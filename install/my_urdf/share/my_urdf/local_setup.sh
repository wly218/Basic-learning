...
: ${AMENT_CURRENT_PREFIX:="/home/wang/hello/install/my_urdf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_urdf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_urdf/environment/path.sh"
